  ...
  <admin-layout>
      ...
      <project-page-wrapper class="mt-5" title="${title}">
        ...
        <div class="grid grid-cols-4">
          <task-table class="pl-10 pr-10 col-span-3" statusid="${statusId}"></task-table>
          <div class="col-span-1 mt-10 mr-3">
            <br />
            <br />
            <br />
            <a href="#">View Diagram</a>
            <choose-file name="Upload Use case Diagram" color="var(--web1)" ></choose-file>
            <br />
            <a href="#">View Diagram</a>
            <choose-file name="Upload Activity Diagrams" color="var(--web1)"></choose-file>
            <br />
            <a href="#">View Diagram</a>
            <choose-file name="Upload Component Diagram" color="var(--web1)"></choose-file>
            <br />
            <a href="#">View Diagram</a>
            <choose-file name="Upload ER Diagram" color="var(--web1)"></choose-file>
            <br />
            <a href="#">View Diagram</a>
            <choose-file name="Upload Prototype" color="var(--web1)"></choose-file>
          </div>
        </div>
...
class ProjectDesigns extends HTMLElement {
  connectedCallback() {
...
customElements.define("project-designs", ProjectDesigns);
