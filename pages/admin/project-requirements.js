import { getUserType } from "../../../lib.js";
...
const statusId = 7;
const title = "Project Requirements";
      ...
      <project-page-wrapper class="mt-5" title="${title}">
        ...
        <div class="grid grid-cols-4">
          ...
          <div class="col-span-1 mt-10 mr-3">
            ...
            <br />
            <br />
            <a href="#">View Requirements Doc</a>
            <choose-file name="Upload Project Requirements Document" color="var(--purple)" ></choose-file>
            <br />
            <a href="#">View Agreement</a>
            <choose-file style="${
              getUserType() === "ADMIN" ? "display: block" : "display: none"
            }" name="Send Confirmation Aggreement" color="var(--web3)" ></choose-file>
          </div>
        </div>
...
class ProjectRequirements extends HTMLElement {
  connectedCallback() {
...
customElements.define("project-requirements", ProjectRequirements);
